...
namespace Lab03_4
{
    class Target_game
    {
        static void Main(string[] args)
        {
                ...
                double[] radius_vectors = new double[3] { 100, 200, 300 };
                Console.WriteLine("Зона мишени 0...200 - 10 баллов;");
                Console.WriteLine("Зона мишени 200...400 - 5 баллов;");
                Console.WriteLine("Зона мишени 400...600 - 1 балл;");
                Console.WriteLine("Центр мишени неизвествен и оценивается как - 20 баллов!;");
